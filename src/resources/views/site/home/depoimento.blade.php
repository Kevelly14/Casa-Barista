 <section class="depo">
              ...
              <div class="site itensDepo">
                <article>
                  ...
                  <div class="estrela">
                  <ul>
                  <li><img src="{{ asset ('barista/assets/estrela.png') }}" alt="Estrela Depoimento"></li>
                   <li><img src="{{ asset ('barista/assets/estrela.png') }}" alt="Estrela Depoimento"></li>
                   <li><img src="{{ asset ('barista/assets/estrela.png') }}" alt="Estrela Depoimento"></li>
                   <li><img src="{{ asset ('barista/assets/estrela.png') }}" alt="Estrela Depoimento"></li>
                   <li><img src="{{ asset ('barista/assets/estrela.png') }}" alt="Estrela Depoimento"></li>
                  ...
                  <div class="dadosDepo">
                    ...
                    <div>
                      ...
                      <h5>Workshop de Métodos de Preparo</h5>
                    </div>
                  </div>
                ...
                <article>
                  ...
                  <div class="dadosDepo">
                    ...
                    <div>
                      ...
                      <h5>Curso de Barista Iniciante</h5>
                    </div>
                  </div>
                ...
                <article>
                    ...
                    <div class="dadosDepo">
                        <p>A combinação de música ao vivo com cafés especiais criou um ambiente acolhedor e sofisticado.
                            Uma experiência perfeita para relaxar e apreciar bons momentos.</p>
                        <img src="{{ asset ('barista/assets/depo.jpg') }}" alt="Foto Depoimento">
                        <h4>Carlos Henrique Lima</h4>
                        <div>
                            <h5>Data: 12/12/2025</h5>
                            <h5>Música & Café</h5>
                        </div>
                    </div>
                ...
                <article>
                    ...
                    <div class="dadosDepo">
                        ...
                        <div>
                            ...
                            <h5>Degustação Sensorial de Cafés</h5>
                        </div>
                    </div>
