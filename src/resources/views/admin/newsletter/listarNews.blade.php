          ...
          <div class="container-fluid">
                  ...
                  <div class="card-header">
                    <div class="row g-2 align-items-center">
                      ...
                      <div class="col-12 col-md-8">
                         <h3 class="card-title">Newsletters cadastradas</h3>
                        <div class="d-flex flex-wrap justify-content-md-end gap-2">
                          <div class="input-group input-group-sm w-auto">
                            ...
                            <input
                             ...
                             id="banner-search"
                              class="form-control"
                               placeholder="Pesquisar newsletter" 
                               aria-label="Pesquisar newsletter" 
                               style="width: 180px">
                          </div>
                            ...
                            <td class="text-end">
                              <div class="btn-group btn-group-sm">
                                ...
                                data-bs-toggle="modal"
                                 data-bs-target="#modal-delete-newsletter" 
                                 aria-label="Deletar"
                                 >
                ...
                <div class="modal-content">
                  <form>
                    <div class="modal-header">
                      <h5 class="modal-title" id="modal-add-user-label">Add new newsletter</h5>
            ...
            <div class="modal fade" id="modal-delete-user" tabindex="-1" aria-labelledby="modal-delete-user-label" aria-hidden="true">
              <div class="modal-dialog">
                <div class="modal-content">
                  <div class="modal-header">
                    <h5 class="modal-title" id="modal-delete-user-label">Delete newsletter</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                  </div>
                  <div class="modal-body">
                    <p class="mb-0">
